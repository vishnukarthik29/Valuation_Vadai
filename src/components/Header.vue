<template>
  <header class="bg-red-600 border-b border-white/10 sticky top-0 z-50 transition-all duration-300">
    <!-- Mobile version - hidden on desktop -->
    <div class="max-w-screen-xxl px-2 py-2 md:hidden">
      <div class="flex justify-between items-center px-2 py-4 sm:px-0">
        ...
        <button
          ...
          class="md:hidden text-gray-100 hover:text-yellow-400 transition-colors duration-300"
        >
    ...
    <div class="max-w-screen-xxl mx-auto ml-10 mr-10 px-2 py-2 sm:px-4 hidden md:block">
      <div class="flex justify-between items-center px-2 py-4 sm:px-0">
        <!-- Logo Section -->
        <div class="flex items-center gap-2 sm:gap-1">
          <router-link to="/">
    ...
    <transition name="slide">
      <div
        v-if="isMenuOpen"
        class="fixed inset-0 z-40 bg-[#db4a2b] top-15 pr-5 backdrop-blur-md md:hidden flex flex-col justify-start px-6 py-10 space-y-4 transition-all duration-300"
      >
        <nav class="mt-2">
